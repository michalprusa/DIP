...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\E-Field\e-field (f=9) [1]
files=s:e-field (f=9)_1,1.m3d
ylabel=s:e-field (f=9) [1]
...
lifetime=s:persistent
result=s:1
treepath=s:1D Results\Complex permitivity extraction\Measurement\THRU\S1,1
files=s:S1,1_2.sig
xlabel=s:Frequency / GHz
title=s:S-Parameter
...
lifetime=s:persistent
result=s:1
treepath=s:1D Results\Complex permitivity extraction\Measurement\THRU\S1,2
files=s:S1,2_3.sig
xlabel=s:Frequency / GHz
title=s:S-Parameter
...
lifetime=s:persistent
result=s:1
treepath=s:1D Results\Complex permitivity extraction\Measurement\THRU\S2,1
files=s:S2,1_4.sig
xlabel=s:Frequency / GHz
title=s:S-Parameter
...
lifetime=s:persistent
result=s:1
treepath=s:1D Results\Complex permitivity extraction\Measurement\THRU\S2,2
files=s:S2,2_5.sig
xlabel=s:Frequency / GHz
title=s:S-Parameter
